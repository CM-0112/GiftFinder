              ...
              <div key={item.id} style={{
                ...
                {item.product_url && (
                  <a href={item.product_url} target="_blank" rel="noopener noreferrer"
                    ...
                    }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M2 11L11 2M11 2H5M11 2V8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></a>
                )}
              </div>
            ))}
          </div>
